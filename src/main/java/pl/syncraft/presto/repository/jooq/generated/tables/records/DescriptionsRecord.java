...
public class DescriptionsRecord extends UpdatableRecordImpl<DescriptionsRecord> implements Record6<Integer, String, String, String, Integer, Integer> {

    private static final long serialVersionUID = -1545199701;
    ...
    /**
     * Setter for <code>public.descriptions.product_id</code>.
     */
    ...
    /**
     * Getter for <code>public.descriptions.product_id</code>.
     */
    ...
    public Field<Integer> field6() {
        return Descriptions.DESCRIPTIONS.PRODUCT_ID;
    }
    ...
    @Override
    public DescriptionsRecord value6(Integer value) {
        setProductId(value);
        return this;
    }

    @Override
    public DescriptionsRecord values(Integer value1, String value2, String value3, String value4, Integer value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DescriptionsRecord(Integer id, String header, String text, String image, Integer type, Integer productId) {
        super(Descriptions.DESCRIPTIONS);
